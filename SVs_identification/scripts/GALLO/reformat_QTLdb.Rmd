...
gff_path = paste(params$workingDir, params$annDir, params$gff_file, sep="")
...
colnames(annotation)<-c("chr", "database", "QTL_type", "start_pos", "end_pos", ".1", ".2", ".3","extra_info")
```
...
org_format_name = org_format %>% mutate(
  extra_info = paste(
    QTL_ID,
    Name,
    Abbrev,
