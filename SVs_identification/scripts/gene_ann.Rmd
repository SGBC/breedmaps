...
find_overlap(vcf_range, gene_range, vcf_df, gene_df){
  overlap = data.frame(findOverlaps(vcf_range, gene_range, maxgap = 0))
...
for (i in 1:length(vcf_files)) {
  ...
  filt_var = df %>% filter(ALT == "<DUP>" | ALT == "<DEL>" | ALT == "<INV>" | ALT == "<INS>")
