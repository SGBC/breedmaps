...
DT:datatable(svs_qtl, row.names = FALSE, extensions = 'FixedColums', options=list(scrollX = TRUE))

svs_gene = find_genes_qtls_around_markers(gene_ann,
                                          svs,
                                          method = "gene",
                                          marker = "haplotype")
DT:datatable(svs_gene, row.names = FALSE, extensions = 'FixedColums', options=list(scrollX = TRUE))
