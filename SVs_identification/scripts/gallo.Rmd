...
```{r add more annotation to genes}

# Translating ID
# dup_gene_ann = dup_gene_cleaned %>% dplyr::select(SV_ID, gene_id)
# universe <- bitr(
#   unique(dup_gene_ann$gene_id),
#   fromType = "ENSEMBL",
#   toType = c("UNIPROT"),
#   OrgDb = org.Dm.eg.db
# )
# universe  =  universe %>% dplyr::rename(gene_id = ENSEMBL, name = UNIPROT)
