...
for (i in 1:length(vcf_files)) {
  ...
  # Filtereing out all variants larger than 50 000 000 since it is too computer heavy to add annotation to these variants
  filt_var_final = filt_var_final %>% dplyr::filter(SV_LENGTH < 50000000)
