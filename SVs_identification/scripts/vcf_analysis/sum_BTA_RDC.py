...
vcf_files_raw = glob.glob(home_path + "/breedmaps/SVs_identification/data/vcf/*.vcf")
vcf_files_filt = glob.glob(home_path + "/breedmaps/SVs_identification/results/filtered_variants/precise_*")
...
top_svs = {k: v for (k, v) in count_filt.items() if v > 30}
