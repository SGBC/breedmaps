...
vcf_files_raw = glob.glob(home_path + "/breedmaps/SVs_identification/data/vcf/BTA*_L*")
vcf_files_filt = glob.glob(home_path + "/breedmaps/SVs_identification/results/filtered_variants/precise_BTA*_L*")
