...
plt.ylabel('# SVs')
plt.savefig('comb_BTA_count_per_file.png')
...
plt.xticks(fontsize=4, rotation=45, ha='right')
plt.ylabel('# SVs')
plt.savefig('comb_BTA_filt_count_per_file.png')
...
plt.xlabel('SV type')
plt.ylabel('# SVs')
plt.savefig("comb_BTA_nonfiltered_svs.png")
...
plt.xlabel('SV type')
plt.ylabel('# SVs')
plt.savefig("comb_BTA_filtered_svs.png")
...
plt.savefig("comb_BTA_counted_nonfiltered_svs.png")
...
plt.savefig("comb_BTA_counted_filtered_svs.png")
...
merged_all_svs.to_csv('comb_BTA_counted_svs.csv', sep=',')
...
top_svs = {pos: count for (pos, count) in count_filt.items() if count > 6}
...
merged_top_svs.to_csv('comb_BTA_top_svs.csv', sep=',')
