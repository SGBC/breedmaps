...
plt.ylabel('# SVs')
plt.savefig('RDC_count_per_file.png')
...
plt.xticks(fontsize=4, rotation=45, ha='right')
plt.ylabel('# SVs')
plt.savefig('RDC_filt_count_per_file.png')
...
plt.xlabel('SV type')
plt.ylabel('# SVs')
plt.savefig("RDC_filtered_svs.png")
...
plt.savefig("RDC_counted_filtered_svs.png")
...
merged_all_svs.to_csv('RDC_counted_svs.csv', sep=',')
...
top_svs = {pos: count for (pos, count) in count_filt.items() if count > 5}
...
merged_top_svs.to_csv('RDC_top_svs.csv', sep=',')
