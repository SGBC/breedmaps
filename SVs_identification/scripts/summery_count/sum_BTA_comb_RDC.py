...
vcf_files_raw = glob.glob(home_path + "/breedmaps/SVs_identification/data/vcf/RDC*") + glob.glob(home_path + "/breedmaps/SVs_identification/data/vcf/combined*")
vcf_files_filt = glob.glob(home_path + "/breedmaps/SVs_identification/results/filtered_variants/precise_RDC*") + glob.glob(home_path + "/breedmaps/SVs_identification/results/filtered_variants/precise_combined*")
...
plt.ylabel('# SVs')
plt.savefig('all_count_per_file.png')
...
plt.xticks(fontsize=4, rotation=45, ha='right')
plt.ylabel('# SVs')
plt.savefig('all_filt_count_per_file.png')
...
plt.xlabel('SV type')
plt.ylabel('# SVs')
plt.savefig("all_nonfiltered_svs.png")
...
plt.xlabel('SV type')
plt.ylabel('# SVs')
plt.savefig("all_filtered_svs.png")
...
plt.savefig("all_counted_nonfiltered_svs.png")
...
plt.savefig("all_counted_filtered_svs.png")
